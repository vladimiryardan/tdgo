...
<div> 
  <!-- Image -->
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('../img/1920x1080/reliable.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white uppercase">How to Be</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">A Successful Transportation Dispatcher</p>
        </div>     
    </div>
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    <p class="g-font-size-18--xs"><strong>How to Be a Successful Transportation Dispatcher</strong>
	</p>
	...
	A dispatcher monitors where trucks are located, checks on how the runs are going, deals with customers, finds the next load assignments 
	for the current truck, and much more. You might be a dispatcher for owner operators, or for company drivers. Since the job is fast-paced 
