...
<div> 
  <!-- Image -->
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('../img/1920x1080/gotStarted.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white uppercase">How I got started in Dispatching</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">By LaChunda Hunter</p>
        </div>     
    </div>
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    <p class="g-font-size-18--xs"><strong>How I got started in Dispatching</strong>
	</p>
    <p class="g-font-size-18--xs">Hello,
    <br>
    My name is LaChunda Hunter, and I will be your new blogger for Dr. Dispatch.
	</p>
	
	<p class="g-font-size-18--xs">
	I have been in the trucking industry for 16 years now. Over my 16 years I have worn many hats. I have worked for companies that provided 
	freight transportation in various ways. I started out as an auditor for Waste Management of Richmond, Virginia. This was a commercial 
	company that dealt with trash and recycle but it started my love for trucking and the trucking industry. While at Waste Management, I was 
	able to ride with all the drivers on their routes. I was able to get a feel and love for the road. My main job there was to observe the 
	routes and time of the pickups. I was hired to save the company money.
	</p>
	
	<p class="g-font-size-18--xs">My next job was for Wilson Trucking of Chester, Virginia. Wilson Trucking gave me the task of putting in all 
	the incoming and outgoing shipments. This is what I like to call the data entry level of trucking. This job was very fast paced. It included 
	putting all details in the system to keep track of everything. The wrong data put in the system could cause a big problem for the shipper, 
	receiver, customer, driver, and the company. This taught me the different things to look for when shipping freight..
	</p>
	...
	intermodal and learning the depths of it.
	</p>
	
	<p class="g-font-size-18--xs">After leaving Baltimore I moved to Charlotte, North Carolina. In Charlotte is where I stood out and on my own. 
	I worked for several different trucking companies in Charlotte, needless to say that every one of them were different and I was able to take 
	something with me from each job opportunity. While at these different companies I held positions as dispatcher, assistant to vice president 
	of a company, human resource head, and office manager. With all these different position I was able to see the whole world of trucking.
	</p>
	
	<p class="g-font-size-18--xs">While working for one of these companies I was introduced to Dr. Dispatch. This program changed my life. I was 
	like my own personal assistant with all my positions that I held.
	</p>
	
	<p class="g-font-size-18--xs">I later went on and started my own trucking company L & L Universal Logistics, LLC. I use Dr. Dispatch for my 
	company as well. I employ owner operator that allow me to do everything and I just leave the driving to them. As I grew as a part of the trucking 
	industry I was asked by drivers, investors, and other dispatchers to teach them my technique. I started doing dispatching classes in 2013 called 
	Dispatching 101, that included how to become a Motor Carrier, the different fields that you can go into, how to dispatch, and of course a touch on 
	Dr. Dispatch. These classes have been very helpful to my students and have allowed them to go on and become Motor Carriers and Dispatchers. I love 
	what I do and I have been doing this so long that I couldn't think of anything else that would bring me more joy.
	</p>
