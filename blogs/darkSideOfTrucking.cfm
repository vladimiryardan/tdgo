...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    <p class="g-font-size-18--xs">The trucking industry consists of a huge population of people. Within this population, the majority 
    of the workers are truck drivers who have a stressful risky, often low paying job, live a transient lifestyle and thus are very 
	...
	<p class="g-font-size-18--xs">The truck driver is often intimidated by the system and unaware that they are being taken advantage of. 
	Therefore they do nothing in response but take it.
	</p>
	...
	<p class="g-font-size-18--xs">&#9755; How to Handle High Risk Deliveries - There may be times when your employer sends you to a 
	delivery location which is unsafe. Know how to handle the situation and protect yourself.
	</p>
	
	<p class="g-font-size-18--xs">&#9755;10 of the Most Bizarre Situations I Experienced in My Trucking Career - Some of my most 
	dangerous delivery experiences.
	</p>
	
	<p class="g-font-size-18--xs">&#9755;10 The Oldest Trucking Industry Scam: Lumpers - Know how to handle a situation with a lumper, 
	should you ever encounter one in your driving career.
	</p>
	
	<p class="g-font-size-18--xs">&#9755;10 What You Need to Know About Depression in Truck Drivers - Truck drivers can suffer from 
	depression due to the nature of the job. Being away from home for long periods, excess stress and worry and insufficient mental 
	breaks from the job. Learn how to recognize depression symptoms and how to handle the condition.
	</p>
	
	<p class="g-font-size-18--xs">&#9755;The Truck Driver Shortage - Is the so-called truck driver shortage but an industry scam to 
	lure new drivers into an industry with plenty of qualified drivers?
	</p>
	
	<p class="g-font-size-18--xs">&#9755;Trucking Industry Facts Distorted For the Sake of Profit - How some companies attempt to profit 
	by stomping on the trucking industry. We're an easy target.
	</p>
	
	<p class="g-font-size-18--xs">&#9755;Bad Truck Drivers - What They Are Doing + How To Fix It - As professionals, we need to be aware 
	of the dangerous truck drivers in our industry and be part of the solution, not part of the problem.
	</p>
