...
<meta name="keywords" content="Truck Dispatching, Experienced Truck Dispatcher, B2B telemarketing company, Customer Service, Social Media, Inbound and Outbound Dispatch Service, Trucking Industry Facts" />
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
  	...
  	<h3 class="g-font-size-21--xs g-font-size-25--sm">Trucking Industry Facts Distorted For the Sake of Profit</h3>
    <p class="g-font-size-18--xs">When trucking industry facts are grossly distorted to appeal 
    to readers of a news publication, I start to see red.
	</p>
    <p class="g-font-size-18--xs">This post is in response to the article,  Trucking Industry Needs to Be Forced 
    to Make Things Safer, by Paul Carpenter, The Morning Call, a New Jersey publication.
	</p>
	<p class="g-font-size-18--xs">Mr Carpenter, this is an interesting article on truck safety and the dangers to 
	passenger car occupants.
	</p>
	<p class="g-font-size-18--xs">However, you have omitted a few very vital facts and statistics.
	</p>
	<!---Trucking Industry Facts Distorted For the Sake of Profit End --->
	<br>	
	<!---Trucking Industry Facts Distorted Once Again--->
	<h3 class="g-font-size-21--xs g-font-size-25--sm">Trucking Industry Facts Distorted Once Again</h3>
	<p class="g-font-size-18--xs">
	&#10004; While you state that 98% of all the fatalities in crashes involving trucks and passenger vehicles 
	occur to the individuals in passenger vehicles, you neglected to mention that in over 90% of these 
	cases, the accidents were caused by the people in their passenger vehicles. This is a well-known 
	industry statistic.
	</p>
	<p class="g-font-size-18--xs">
	&#10004; You failed to mention that passenger vehicles as a whole are involved in over 100X as many accidents 
	as commercial vehicles.
	</p>
	<p class="g-font-size-18--xs">
	&#10004; You also failed to mention that the driving skills required to get a driver's license are virtually nil, 
	while obtaining a CDL is far more controlled, specifically for safety reasons. It takes a far greater 
	degree of skill to operate a tractor trailer.
	</p>
	<p class="g-font-size-18--xs">
	&#10004; Please note that strenuous delivery schedules and lack of rest for the professional truck driver can be 
	attributed directly to the schedules and needs of shippers and receivers. Not the truck drivers.
	</p>
	<p class="g-font-size-18--xs">
	All truckers would love to have a full night's sleep every night, just like you.
	</p>
	<p class="g-font-size-18--xs">
	You say the public should go back to supporting the rail industry. Let us know when the rail lines run directly 
	to the doors of the grocery stores.
	</p>
	<p class="g-font-size-18--xs">
	Look at the photo included in your article of the accident scene. The vehicle in the crash appears to be a grocery 
	delivery truck and trailer. We need trucks. We can't do without them.
	</p>
	<p class="g-font-size-18--xs">
	As for the politicians, they know who butters their bread.
	</p>
	<p class="g-font-size-18--xs">
	If any one of them implemented a bill introducing retraining the existing driving public because as a whole they're 
	completely unskilled, that politician would never get another vote, other than a few from truck drivers.
	</p>
	<p class="g-font-size-18--xs">
	Fuel taxes are based on volume of fuel sold. Do you suppose your car burns as much fuel each year as a truck that 
	averages 100,000 miles each year?
	</p>
	<p class="g-font-size-18--xs">
	I agree that that accident on I-78 was tragic. I also agree that particular trucking company hired the wrong truck 
	driver.
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	In fact, I presently know of a newspaper by the name of the Morning Call who employs at least one writer that clearly 
	isn't qualified to do his job, which is thoroughly researching a subject and submitting an informed and accurate story 
	to their readers.
	</p>
	<!---Trucking Industry Facts Distorted Once Again End --->
	<br>
