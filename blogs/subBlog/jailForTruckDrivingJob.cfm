...
<meta name="keywords" content="Truck Dispatching, Experienced Truck Dispatcher, B2B telemarketing company, Customer Service, Social Media, Inbound and Outbound Dispatch Service, Jail For Your Truck Driving Job" />
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
  	<!---Are You Willing to Go to Jail For Your Truck Driving Job?--->
  	<h3 class="g-font-size-21--xs g-font-size-25--sm">Are You Willing to Go to Jail For Your Truck Driving Job?</h3>
    <p class="g-font-size-18--xs">Driving a truck is more than just shifting gears and pointing the truck in the right direction.
	</p>
    <p class="g-font-size-18--xs">It involves good judgement, fast decisions, reaction time and many other factors to do the job well and safely.
	</p>
	...
	<p class="g-font-size-18--xs">How? Because truck driving is a dangerous career and people can get hurt and/or killed as a result of a tractor trailer accident.
	</p>
	...
	<!---Are You Willing to Go to Jail For Your Truck Driving Job? End --->
	<br>	
	<!---WHAT CAUSES TRUCKING ACCIDENTS TO HAPPEN? --->
	<h3 class="g-font-size-21--xs g-font-size-25--sm">WHAT CAUSES TRUCKING ACCIDENTS TO HAPPEN?</h3>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	Some truck drivers are known to be distracted from their driving by electronic equipment. It's just one more thing a professional 
	truck driver must deal with on a daily basis. Law enforcement bodies have recognized that this is indeed a problem and are clamping 
	down on this unsafe practice.
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	Dash cams can be an absolute life saver for the truck driver. A driver facing camera and at least one road facing camera are an investment 
	in your safety, innocence and well being as a professional trucker.
	</p>
	<!---WHAT CAUSES TRUCKING ACCIDENTS TO HAPPEN? End --->
	<h3 class="g-font-size-21--xs g-font-size-25--sm">ARE THE RISKS OF A TRUCK DRIVING PROFESSION WORTH IT?</h3>
	<p class="g-font-size-18--xs">
	In the past, truck driving jobs weren't easier, but the jobs paid better.
	</p>
	<p class="g-font-size-18--xs">
	The wages were in line with the cost of living at the time. So, for the risk drivers were taking at that time, 
	generous wages helped to compensate if anything adverse happened.
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	However, in trucking, no such thing seems to exist in this business. This means that if you are involved in an accident, 
	you may be required to pay out on some or all of the damages, and most likely legal costs as well.
	</p>
	<p class="g-font-size-18--xs">
