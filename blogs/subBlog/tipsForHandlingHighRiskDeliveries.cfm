...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
  	...
  	<h3 class="g-font-size-21--xs g-font-size-25--sm">Truck Driver Tips For Handling High Risk Deliveries</h3>
    <p class="g-font-size-18--xs">Unsafe, high risk deliveries are an unfortunate risk of a truck driver's job, 
    although truly, not part of the job. It's vital to know how to handle a situation, should you find yourself 
    in an unsafe area.
	</p>
    <p class="g-font-size-18--xs">Drivers should ask the receiver, when delivering to a new location about any
     safety issues the area might present. Ask questions to find out whatever you're able about the area.
	</p>
	...
	<p class="g-font-size-18--xs">Usually it's best to go in and out of an area in daylight hours. If it's
	 discovered that an area is very high risk, no matter what time of day or night, call your dispatcher 
	 and tell him so. Don't be concerned to refuse to deliver in an unsafe zone.
	</p>
	<p class="g-font-size-18--xs">
	"We've never had a problem there before", is the standard line from the dispatcher when trying to convince
	 a driver to go into a high risk zone to deliver or pick up a load.
	</p>
	<p class="g-font-size-18--xs">
	...
	1. Dispatchers will sometimes say things which just are not true. They probably won't tell you if there
	 have been problems in the area previously. 
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	&#9755; If you have a GPS, program it to guide you to the quickest way out of the area and back to the highway.
	Or, if possible, get out of the area, the same route you came into the area, to avoid getting lost in a bad
	neighbourhood.
	</p>
	<p class="g-font-size-18--xs">
	&#9755; Take the time to trip plan. It will pay off huge. At the very least, talk with the receiver by phone
	 before going into the area.
	</p>	
	<!---In an Unsafe Area? What to Do End --->
	<br>
	...
	<p class="g-font-size-18--xs">
	The main focus of trucking companies is profit. Sometimes, their goal to have a profitable quarter superceeds
	 everything else. Sadly, they'll sometimes sacrifice the safety of their drivers, to reach their financial goals.
	</p>
	<p class="g-font-size-18--xs">
	While carriers will say safety is always their number one goal, it may not always be true. The driver is the one
	 ultimately responsible for their own personal safety.
	</p>
	<p class="g-font-size-18--xs">
	At the end of the day, the most important thing to the driver, is to arrive home safely to family and friends.
	Yes, the company may be sorry if one of their drivers was hurt on the job. But it's the driver's life which 
	will change, not theirs.
	</p>
	<p class="g-font-size-18--xs">
	Ask the families of Jason Rivenburgh and Michael Boeglin, both truckers who lost their lives, by being at the
	 wrong place at the wrong time.
	</p>
	<p class="g-font-size-18--xs">
	When the chips are down, drivers must do what's best for their personal safety and well being regardless of what
