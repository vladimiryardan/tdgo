...
<meta name="keywords" content="Truck Dispatching, Experienced Truck Dispatcher, B2B telemarketing company, Customer Service, Social Media, Inbound and Outbound Dispatch Service, Dirtiest Trucking Company Trick" />
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
  	...
  	<h3 class="g-font-size-21--xs g-font-size-25--sm">The Dirtiest Trucking Company Trick I've Ever Heard Of</h3>
    <p class="g-font-size-18--xs">I've been around the trucking industry for more than 40 years. I thought I had heard 
    all of the nasty tricks pulled on truck drivers.
	</p>
    <p class="g-font-size-18--xs">But I was wrong. A number of drivers with who I spoke with, recently brought to my 
    attention to the dirtiest trick I've ever heard of.
	</p>
	<!---The Dirtiest Trucking Company Trick I've Ever Heard Of End --->
	<br>	
	<!---The Dirtiest Trucking Company Trick--->
	<h3 class="g-font-size-21--xs g-font-size-25--sm">The Dirtiest Trucking Company Trick - How It Works</h3>
	<p class="g-font-size-18--xs">
	Here's how the situation works.
	</p>
	<p class="g-font-size-18--xs">
	A trucking company advertises for drivers. For example, the company is interested in 40 drivers who 
	are living in the Indianapolis area.
	</p>
	<p class="g-font-size-18--xs">
	The trucking company arranges for out of town drivers, to meet to travel by bus to the trucking company. 
	The bus will take the drivers to the company terminal for training and hiring procedures. Sounds like a 
	pretty good deal and a great way to get a driving job.
	</p>
	<!---The Dirtiest Trucking Company Trick End --->
	<br>
	<!---Leaving the Driver Stranded--->
	<h3 class="g-font-size-21--xs g-font-size-25--sm">Leaving the Driver Stranded</h3>
	<p class="g-font-size-18--xs">
	HOWEVER, some of these trucking companies turn away some of the drivers from their hiring procedures.
	</p>
	<p class="g-font-size-18--xs">
	The drivers who did not make the cut and get a truck driving job, are turned away. Transportation is 
	NOT provided for their return trip home.
	</p>
	<p class="g-font-size-18--xs">
	In many cases, this trip could be a long way from their home and be very costly for the driver to find a 
	means of transportation home. The drivers are left stranded in a city, usually hundreds of miles from home. 
	Many of the drivers have not equipped themselves with sufficient money to pay for their way home.
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	These trucking companies leaving these drivers stranded in a strange city, with little to no money in their 
	pocket, as they hadn't expected to require much money.
	</p>
	<p class="g-font-size-18--xs">
	It is also a very dangerous situation to leave a driver in. If the driver decided to hitch hike home, from 
	a city like Chicago, the driver (especially in the winter time) could freeze to death, get hit by a vehicle, 
	mugged or killed.
	</p>
	<!---Leaving the Driver Stranded End --->
	<br>
