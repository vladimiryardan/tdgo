...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    But, it only take a few to create a danger zone on a public highway.
	</p>
	...
	<p class="g-font-size-18--xs">
	&#9755; <b>Truck Driver Distracted Driving</b>
	</p>
	<p class="g-font-size-18--xs">
	Ever have one of those days, when you're truly disappointed with mankind? When you 
	see something so stupid, you are ashamed to be a human being AND a truck driver ?
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	I guess we could also blame the speed limiting function on modern day trucks, belonging 
	to big fleets with an eye on fuel and cost savings. It can be pretty boring and 
	frustrating to drive at slower speeds.
	</p>
	<p class="g-font-size-18--xs">
	Truly? The real fault ultimately lies with the lack of judgement and poor skills of the 
	truck driver behind the wheel. The truck driver is responsible for their actions.
	</p>
	<p class="g-font-size-18--xs">
	&#9755; <b>Truck Drivers Driving Too Fast </b>
	</p>
	<p class="g-font-size-18--xs">
	...
	<p class="g-font-size-18--xs">
	It's a sad fact that the driving public often comes in contact with these low grade dangerous drivers. 
	They then judge ALL truck drivers as being reckless and dangerous drivers who bully the public on the roadways.
	</p>
	<p class="g-font-size-18--xs">
