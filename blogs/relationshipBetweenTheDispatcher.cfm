...
<div> 
  <!-- Image -->
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('../img/1920x1080/relationship.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white uppercase">Dispatcher And The Driver</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">The Relationship Between</p>
        </div>     
    </div>
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
	...
	<p class="g-font-size-18--xs">Building a relationship between the dispatcher and the driver start from day one. The day that the driver becomes 
	a part of the team is when it starts. Become familiar with the driver. Learn their name. Find out if they prefer a nick name or just be called 
	Mr. or Mrs. Driver. Find out how long they have been driving. Veteran drivers usually are set in their ways and have their way of doing things. 
	See if there is something that you can do make them comfortable with you.
	</p>
