...
<meta name="keywords" content="Truck Dispatching, Experienced Truck Dispatcher, B2B telemarketing company, Customer Service, Social Media, Inbound and Outbound Dispatch Service, FAQ about truck dispatching service" />
<meta name="description" content="Truck Dispatcher, Experienced Truck Dispatcher, Dispatching service, Customer Service,  Load Carrier, Truck Driver Helper, Safe Delivery, Arrange Pick Up, FAQ about truck dispatching service">
...
<div> 
  <!-- Image -->
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('../img/1920x1080/truckFAQ.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white uppercase">FAQ</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">ABOUT TRUCKING DISPATCH SERVICE</p>
        </div>     
    </div>
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    <p class="g-font-size-18--xs"><strong>FAQ: ABOUT TRUCKING DISPATCH SERVICE</strong>
	</p>
    <p class="g-font-size-18--xs"><b>Question: Do I need to complete a freight broker's set up packet every time Trucking Dispatch 
    Service gives me a freight load?</b>
	</p>
	
	<p class="g-font-size-18--xs">
		<b>Answer:</b> No. We will fill out all packets for you. When you set up service with us you will provide us with your MC#, copy 
		of insurance, complete W-9 and a dispatch authorization form that will give Trucking Dispatch Service the authorization to 
		fill any freight broker's set up packet for you and accept any freight load you agree to take on your name.
	</p>
	
	<p class="g-font-size-18--xs"><b>Question: Who do you do business with and how do you get loads?</b>
	</p>
	
	<p class="g-font-size-18--xs"><b>Answer:</b> We only accept freight loads from reputable freight brokers that we know pay correctly. 
	At Trucking Dispatch Service we get freight loads from 11 different load boards. We have numerous freight Brokers that steadily 
	call us offering us their freight loads to our truck base. They've realized that by proposing their freight loads to our Owner 
	Operators base they receive professional service and more importantly they avoid putting their loads on load boards and wait for 
	an unknown carrier to call them.
	</p>
	
	<p class="g-font-size-18--xs"><b>Question: What do you need from me in order to begin work?</b>
	</p>
	...
	<p class="g-font-size-18--xs"><b>Answer:</b>We need three things from you:
	<ul>
		<li >
		...
		<li >
			Service agreement filled and signed. This is a form where you agree to do business with Trucking Dispatch Service. 
			This is NOT A CONTRACT.
		</li>
		<li >
			Dispatch authorization form filled and signed. In this form you authorize Trucking Dispatch Service to accept freight 
			loads for you, fill out broker's set up packets for you and sign Load confirmations and contact your insurance company 
			for every load. It is like a power of attorney where you authorize to book loads for you in your name and you don't have 
			to fill out any paper work.
		</li>
		<li >
			A filled and signed credit/debit card authorization form. Where you authorized Trucking Dispatch Service to charge you for services rendered.
		</li>
	</ul>
	</p>
	
	<p class="g-font-size-18--xs"><b>Question: Can I reject a freight load you offer me?</b>
	</p>
	
	<p class="g-font-size-18--xs">Answer: Of course, you may not be interested in every freight load that our truck dispatchers find 
	for you, and if there is a freight load that does not match your necessities, just say no to us, plain and simple. Your truck dispatch 
	will keep on looking for a freight load that suits you, until he/she finds you one that you like.
	</p>
	
	<p class="g-font-size-18--xs"><b>Question: Who creates the invoice for the load and how fast do I get paid?</b>
	</p>
	
	<p class="g-font-size-18--xs"><b>Answer:</b> If you chose our Full Service Package (6.9% of the load) Trucking Dispatch Service takes care of 
	invoicing the brokers and follow your payment status until you receive it straight on your bank acount, check on the mail or through a 
	comcheck express code. All freight brokers or freight shippers will pay you directly, how fast you get paid depends on them.
	</p>
	
	<p class="g-font-size-18--xs"><b>Question: Do I need to fill out any contracts to use your service?</b>
	</p>
	
	<p class="g-font-size-18--xs">Answer: No. There are no contracts to fill out with Trucking Dispatch Service; we only need the five items 
	mentioned above in order to begin working. You can cancel our services any time just call us and tell us that you don't want to use our 
	service anymore and we will erase all your information from our database
	</p>
	
	<p class="g-font-size-18--xs"><b>Question: Do you work in specific arears or you cover all 48 states?</b>
	</p>
	
	<p class="g-font-size-18--xs"><b>Answer:</b> Yes we cover all 48 states, you can call our independent truck dispatch for a load from anywhere, 
	your house, your yard, the place where you delivered your last load or a truck stop. It doesn't matter.
	</p>
