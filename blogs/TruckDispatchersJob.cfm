...
<div> 
  <!-- Image -->
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('../img/1920x1080/dispatchersJob.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white uppercase">An Inside Look at a Truck Dispatcher's Job</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity"> C.H. Robinson </p>
        </div>     
    </div>
</div>
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
	...
	<p class="g-font-size-18--xs">There is no typical day, which is why I love this job. Every day there is something new, 
	something challenging, and something I have to resolve. I wake up at 4 a.m. I immediately check my email to make sure 
	no problems came up during my six hours of sleep.
	</p>
	...
	<p class="g-font-size-18--xs">Things start to pick up when the business day starts. And every day customers call expecting 
	miracles. We do the best we can to accommodate them based on the information we have at hand. Around lunchtime, I start on 
	the next day's dispatch, but one phone call can throw it all out the window. My biggest goals are to make our customers happy 
	as well as support our drivers with the miles they need to support their families.
	</p>
	
	<p class="g-font-size-18--xs"><strong>What factors come into play when deciding to take a load for a driver?</strong>
	</p>
	...
	<p class="g-font-size-18--xs"><strong>What technology do you use? </strong>
	</p>
	...
	<p class="g-font-size-18--xs"><strong>Besides satellite communication, how do you communicate with drivers?</strong> Cell phones.
	</p>
	
	<p class="g-font-size-18--xs"><strong>What is the most rewarding part of your job? </strong>
	</p>
	
	<p class="g-font-size-18--xs">At the end of the day, I like to know I got everything tied down. It's important for me to know the boss, 
	our customers, and our drivers are happy. That means I can go home and have dinner with my family and not be distracted or get interrupted.
	</p>
	
	<p class="g-font-size-18--xs"><strong>How long have you been in the trucking industry? </strong>
	</p>
	
	<p class="g-font-size-18--xs">I have been in trucking for 22 years. I have been with A.N. Webber for 10 years. My father got me started in 
	this business. I am not sure if I should thank him or give him a kick in the rear end. Regardless, I am carrying on his legacy.
	</p>
	
	<p class="g-font-size-18--xs"><strong>What are the biggest changes you've seen in the industry during that time? </strong>
	</p>
	
	<p class="g-font-size-18--xs">Trucking is trucking. The one thing that will never change is you pick up freight from point A and deliver it 
	to point B. The biggest changes on how that gets accomplished are technology and regulations, which almost seem to battle one another. Technology 
	makes everything easier, but regulations have made my job and our drivers' jobs a lot harder.
	</p>
	
	<p class="g-font-size-18--xs">As you can see, being a dispatcher is an around the clock job. The phone can ring at any hour of the day and that one 
	phone call can throw an entire day off. Thanks to my time with Jim, I have a better understanding of what it is like to be a dispatcher. 
	</p>

	<p class="g-font-size-18--xs">I would love to hear from others on their experience as a dispatcher. Please share your comment in the comment section. 
	</p>
