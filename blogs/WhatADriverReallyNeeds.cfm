...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    <p class="g-font-size-18--xs"><strong>What a driver really needs</strong>
	</p>
    <p class="g-font-size-18--xs">At the most basic level, a driver needs food, water, warmth and rest. With the trucks offered by most 
    companies today, along with ELDs disincentivizing everyone to push, warmth in a decent place to rest and the time to do it is pretty 
    well covered.
	</p>
	
	<p class="g-font-size-18--xs">
		Given most are in trucking to support their families, let's not forget that all those needs must be covered for the driver's 
		family as well. If momma is not happy, I guarantee momma's driver's not going to be happy.
	</p>
	
	<p class="g-font-size-18--xs">As I have noted before, drivers are pretty much being paid today what they were paid in 1982, and when 
	it comes to buying power a fair amount less than that - sad, but true. By the end of 1982 the average home sold for about $71,000 dollars. 
	Today that same home sells for near $230K, a threefold-and-more increase.
	</p>
	
	<p class="g-font-size-18--xs">The average cost of a new car in the 1980s was about $7K, and gas for that car averaged 90 cents a gallon. 
	You get the point. Driver pay is such that, at many companies today, drivers' most basic needs at the bottom of the pyramid are not being met. 
	But let's move on to the next level: Safety.
	</p>
	
	<p class="g-font-size-18--xs">As parenthetically intimated above, inadequate parking presents a big red flag here. What else can be done 
	to improve safety for drivers? If you want to employ women over-the-road, think about personal body alarms or parking alternatives - many 
	of our truck stops are not well lit, and walking from the back of a three - or four-acre lot to use a bathroom in the middle of the night 
	can be daunting.
	</p>
	
	<p class="g-font-size-18--xs">The next level of needs is in relationships - "love/belonging" in the pyramid above. We've already covered 
	what happens when momma/daddy isn't happy, and with communications technology it is much easier for drivers to stay connected with home. 
	Still, there is room for improvement - enable Wi-Fi hotspots in the trucks for drivers. Auto manufactures have been putting Wi-Fi capabilities 
	in their cars for years now, so it is not much of a stretch. Today a driver may not be able to attend that ball game or recital in person, 
	but with Wi-Fi and a phone they can easily be there virtually.
	</p>
	
	<p class="g-font-size-18--xs">Drivers can become disconnected from their communities because they are gone so much, but simple things like 
	church services, picnics, maybe a company fishing derby for drivers in the area can go a long way.
	</p>
	
	<p class="g-font-size-18--xs">Next, Maslow shows us that esteem and prestige are necessary. Simply put, this level of the pyramid points the 
	way for acknowledging accomplishments: There is not one single driver on the road who has reached that 1, 2, or 3-million-mile safe driving 
	mark who is not proud of that accomplishment. Most companies are very good at bragging about that as a recruiting tool. But what else could 
	they do?
	</p>
	
	<p class="g-font-size-18--xs">Money is always nice, but it takes close to ten years to hit the 1-million-mile mark. Along the way, perhaps 
	it makes sense to give a driver a stake in the company via profit-sharing and/or employee-ownership schemes. A vested interest in the company 
	would no doubt give an operator a sense of appreciation and a tangible reason to remain employed by a fleet.
	</p>
	
	<p class="g-font-size-18--xs">The generations coming up are looking for companies to be committed to the communities they belong to, companies 
	that with them support charities and/or local environmental issues. My company does a breast-cancer biker run every year to raise money for breast 
	cancer. They encourage the safety needed for drivers to participate in both sate and national truck rodeos.
	</p>
	
	<p class="g-font-size-18--xs">Finally, we come to self-actualization, or achieving one's full potential. The trucking industry is one of the few 
	industries where there doesn't seem to be a ceiling including glass to be broken. Man or woman, a driver can be a company driver their entire career, 
	they can become a small business by owning and building their own trucking company - but for too many, that's about it. Few opportunities exist outside 
	the truck that a driver can move into and expect the same or better income.
	</p>
	
	<p class="g-font-size-18--xs">While I have known some drivers who tried dispatching, most have gone back to driving. Some have tried to become brokers, 
	some with success, but sales often proves a whole new ballgame.
	</p>
	
	<p class="g-font-size-18--xs">Very few find the opportunity to advance for accomplishment or for a better family life.
	</p>
	
	<p class="g-font-size-18--xs">As with so many trucking issues, that brings us back to pay. Without money, the first basic needs, on which the entire 
	pyramid sits, cannot be met. Last year drivers saw movement. Some companies started salary-type programs at above-average rates; others went to hourly 
	wages and/or minimum weekly guarantees. With ELDs we have begun to more short hauls and drop-and-hook operations.
	 The FMCSA has hinted at more flexibility. These help, but drivers need a sense of pride. How can we bring that back?
	</p>
