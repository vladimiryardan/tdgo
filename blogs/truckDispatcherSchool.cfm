...
<meta name="keywords" content="Truck Dispatching, Experienced Truck Dispatcher, B2B telemarketing company, Customer Service, Social Media, Inbound and Outbound Dispatch Service, Truck Dispatcher School" />
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('../img/1920x1080/overdryve.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white uppercase">Truck Dispatcher School</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">What you need before enrolling</p>
        </div>     
    </div>
...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs">
  <div class="g-text-left--lg">
    ...
    <p class="g-font-size-18--xs"><strong>What you need before enrolling for a Truck Dispatcher School</strong>
	</p>
    <p class="g-font-size-18--xs">It is no news that the trucking system is the pillar of an economy. According to statistics the trucking 
    transport industry is responsible for the movement of most goods between the U.S and Canada and realized about $67 billion of revenues 
    back in 2005.
	</p>
	
	<p class="g-font-size-18--xs">Although truck driving is the principal occupation of most Canadian men, it is evident this lucrative 
	occupation is not for everyone since it requires one spends long hours and distance far from home. However, if you are interested in 
	this noble profession, then this guide would expose you to what you need before taking a dispatcher course at a dispatcher school.
	</p>
	
	<p class="g-font-size-18--xs"><strong>What to expect from a Dispatcher school</strong>
	</p>
	
	<p class="g-font-size-18--xs">
	Dispatchers are trained to be communication specialists and are regarded as the common central or nerve center for trucking companies. 
	These individuals coordinate the movement of all freight and trucks. Hence, a Dispatcher school equips them to:
	</p>
	
	<p class="g-font-size-18--xs">Match freight with trucks, making sure that the organization's assets are utilized adequately at all times 
	(i.e., every truck truck must carry a load while embarking on long trips)
	<ul>
		<li >
	...
	<p class="g-font-size-18--xs"><strong>What skills you need before enrolling for a Dispatcher School</strong>
	</p>
	
	<p class="g-font-size-18--xs">If you want to register for truck dispatcher courses, and you don't know what it takes, 
	the following are the necessary skills you should have:
	<ul>
		<li >
	...
	<p class="g-font-size-18--xs">Generally, you need a high school certificate. Some dispatcher school will also provide advanced 
	dispatcher training, and teach dispatchers how to use trading tools.
	</p>
	
	<p class="g-font-size-18--xs">What are the tools Dispatcher school use to teach their students
	</p>
	
	<p class="g-font-size-18--xs">Enrolling for a Dispatcher school means you would be shown how to use a variety of tools including
	<ul>
		<li >
			Two-way radio
		</li>
	...
	<p class="g-font-size-18--xs">If you are interested in ensuring that a trucking operation is done effectively, you need 
	to consider enrolling for a dispatcher school. It would make you more credible to potential employers.
	</p>
