...
<div> 
  <!-- Image -->
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('img/1920x1080/blogs.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white">CHECK OUT OUR BLOGS</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">We Find Loads For Trucks, We Will Keep You Loaded, We Will Keep You Moving and We Will Help You To Stay PROFITABLE</p>
