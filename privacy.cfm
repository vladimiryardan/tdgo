...
<div id="js__scroll-to-section5"  class="container g-padding-y-80--xs g-padding-y-125--sm">
  <div class="g-text-left--lg">
    ...
    <p> This privacy policy sets out how TRUCK DISPATCH GO uses and protects any information that you 
        give us when you use this website.
	</p>
	
	<p>TRUCK DISPATCH GO is committed to ensuring that your privacy is protected. Should we ask you to provide 
        certain information by which you can be identified when using this website, then you can 
	...
	<p>
		TRUCK DISPATCH GO may change this policy from time to time by updating this page. You should check this page 
        from time to time to ensure that you are happy with any changes. This policy is effective 
        from August 2018.
	</p>
	...
	<p>
		A. We will collect and use of personal information solely with the objective of fulfilling those 
	...
	<p>
		What requirements you have for virtual support.
	</p>
	<p>
		B. We will only retain personal information as long as necessary for the fulfillment of those 
		purposes. 
	</p>
	<p>
		C. We will collect personal information by lawful and fair means and, where appropriate, with the 
		knowledge or consent of the individual concerned. 
	</p>
	<p>
		D. Personal data should be relevant to the purposes for which it is to be used, and, to the extent 
		necessary for those purposes, should be accurate, complete, and up-to-date. 
	</p>
	<p>
		E. We will protect personal information by reasonable security safeguards against loss or theft, 
		as well as unauthorized access, disclosure, copying, use or modification.
	</p>
	<p>
		F. We will make readily available to customers information about our policies and practices 
	...
	<p>
		A cookie is a small file that is placed on your computer's hard drive that helps analyze 
        web traffic. Cookies allow web applications to respond to you as an individual. The web 
	...
	<p>
        ...
        information that you provide whilst visiting such sites, and such sites are not governed 
