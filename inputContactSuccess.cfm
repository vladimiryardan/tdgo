...
<div> 
  <!-- Image -->
    ...
    <div class="g-fullheight--xs g-bg-position--center" style="background: url('img/1920x1080/success.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white">THANK YOU</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">For Choosing Truck Dispatch Go. We Have Received Your Message.</p>
        </div>     
    </div>
