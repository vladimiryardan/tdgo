  ...
  <div class="swiper-wrapper">
    <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/truck1.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white">The Immigration Consultancy <br>
            that You Can Trust</h2>
          <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">We are a licensed immigration consulting firm located in Edmonton, AB Canada.</p>
        </div>
    ...
    <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/truck2.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-30--xs">
          <div class="g-margin-b-30--xs">
            <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white">Only 4<br>
              Easy Steps</h2>
            <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">We Will Take You From The Initial Stage Of Establishing What You Want <br>
              To The Final Stage Of Attaining Your Visa.</p>
          </div>
    ...
    <div class="g-fullheight--xs g-bg-position--center g-bg-position--bottom swiper-slide" style="background: url('img/1920x1080/truck3.jpg');">
      <div class="container g-text-center--xs g-ver-center--xs">
        <div class="g-margin-b-60--xs">
          <div class="g-margin-b-30--xs">
            <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white">Why hire a licensed <br>
              Immigration Consultant?</h2>
            <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">Immigrating to Canada is a complex process. <br>
              <br>
              An immigration consultant is someone who will help and advise you <br>
              throughout the process of obtaining your visa. </p>
          </div>
  ...
  <div class="row g-margin-b-10--xs">
    ...
    <div class="col-md-5 g-margin-b-10--xs g-margin-b-0--lg g-margin-t-10--lg g-margin-l-20--lg">
      <div class="g-margin-b-30--xs">
        ...
        <p>Our firm specializes in Canada visa applications including temporary visa for visitors, students, workers, NAFTA and permanent residence visas for skilled workers, caregivers, business class, family class sponsorship as well as PR card renewal and citizenship applications.​</p>
        <p>Our firm also handles complex immigration visa issues.​</p>
        <p>Our company is known for its dedication, honesty and exclusive personalized service and to maintain a strong reputation in the industry.​</p>
      </div>
    </div>
    <div class="col-md-11 g-margin-b-10--xs g-margin-b-0--lg g-margin-t-10--lg g-margin-l-20--lg">
      <div class="row">
        ...
        <ul class="list-unstyled col-xs-4 g-full-width--xs g-ul-li-tb-5--xs g-margin-b-20--xs g-margin-b-0--sm">
          <li>
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-15--xs">Temporary Resident Class</p>
            Initial and Renewal:</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Visitor Visa or Supervisa</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Working Visa</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Open Work Permit</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Student Visa</li>
        </ul>
        <ul class="list-unstyled col-xs-4 g-full-width--xs g-ul-li-tb-5--xs g-margin-b-20--xs g-margin-b-0--sm">
          <li>
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-15--xs">Permanent Resident Class</p>
          </li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Family Sponsorship</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Caregiver</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Express Entry</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Federal Skilled Worker</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Skilled Trade</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Canadian Experience Class</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>PNP</li>
          <li><i class="g-font-size-12--xs g-color--primary g-margin-r-10--xs ti-check"></i>Provincial Nominee Program</li>
        </ul>
        <ul class="list-unstyled col-xs-2 g-full-width--xs g-ul-li-tb-5--xs g-margin-b-20--xs g-margin-b-0--sm">
          <li>
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-15--xs">Citizenship</p>
          </li>
        </ul>
        <ul class="list-unstyled col-xs-2 g-full-width--xs g-ul-li-tb-5--xs g-margin-b-20--xs g-margin-b-0--sm">
          <li>
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-15--xs">LMIA</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <ul class="list-inline row g-margin-b-100--xs">
      ...
      <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1">
        <div class="center-block g-text-center--xs">
          ...
          <div class="g-padding-x-20--xs">
            <h3 class="g-font-size-18--xs g-color--white">Better Title?</h3>
